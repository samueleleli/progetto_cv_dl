...
g_classes = [x.rstrip() for x in open(os.path.join(ROOT_DIR, 'data', 'sinthcity', 'meta', 'class_names.txt'))]
g_class2label = {cls: i for i, cls in enumerate(g_classes)}
g_class2color = {'building': [0, 255, 0],
                 'car': [0, 0, 255],
                 'natural-ground': [0, 255, 255],
                 'ground': [255, 255, 0],
                 'pole-like': [255, 0, 255],
                 'road': [100, 100, 255],
                 'street-furniture': [200, 200, 100],
                 'tree': [170, 120, 200],
                 'pavement': [255, 0, 0],
                 'clutter': [50, 50, 50]}
g_easy_view_labels = [0, 1, 5, 6, 7, 3]
...
def room2blocks(data, label, num_point, block_size=1.0, stride=1.0,
    ...
    block_label_list = []
    idx = 0
    print(" - - len(xbeg_list):",len(xbeg_list))
...
def room2blocks_plus_normalized(data_label, num_point, block_size, stride,
    ...
    print(" - data_batch.shape[0]:",data_batch.shape[0])
    ...
    return [max_room_x, max_room_y, max_room_z], new_data_batch, label_batch
