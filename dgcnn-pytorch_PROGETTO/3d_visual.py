...
if(REAL_COLORS):
  ...
  ax.legend(handles=[building_patch, car_patch, natural_ground_patch, ground_patch, pole_like_patch,road_patch, street_forniture_patch, tree_patch, pavement_patch], loc='upper left')
  # plt.show()
