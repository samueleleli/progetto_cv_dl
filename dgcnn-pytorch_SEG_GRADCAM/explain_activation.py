...
def explain_act_semseg(args):
    ...
    if True:
        if True:
            ...
            # else:
            #     cam = gradcam.GradCAM(model=model,
            #                           target_layer=model.module.dp2, #conv5,
            #                           use_cuda=False)
            ...
            #         o3d.io.write_point_cloud("results/gradientPlot/g_MED6_{}_tg{}_gt{}_p{}.ply".format(idx[i], cls, gt, pred), pcd)
            ...
            for data, seg, max in test_loader:
                # a = np.load("results/actGradExtraction/act_conv5_{}.npy".format(idx[i]))
                a = np.load('checkpoints/' + args.exp_name+ "/actGradExtraction/act_conv9_{}.npy".format(i))
                ...
                o3d.io.write_point_cloud('checkpoints/' + args.exp_name + "/actGradExtractionPlot/actGradExtractionPlotA/a_median_{}.ply".format(i), pcd)
